...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`Y:\我的雲端硬碟\my-classroom-tools\`（自動跨電腦同步）
- 🐙 GitHub repo：`jamic710808/my-classroom-tools`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`secondbrain/my-classroom-tools/工作筆記.md`（想法的家）
